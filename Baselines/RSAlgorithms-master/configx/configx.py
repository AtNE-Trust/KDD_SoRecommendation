...
class ConfigX(object):
    ...
    def __init__(self):
        ...
        self.rating_path = "../data/%s_ratings_test.txt" % self.dataset_name  # the raw ratings data file
        self.rating_cv_path = "../data/cv/"  # the cross validation file of ratings data
        self.trust_path = '../data/%s_trust_test.txt' % self.dataset_name  # the raw trust data file
